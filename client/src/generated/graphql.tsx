...
export type PostSnippetFragment = (
  { __typename?: 'Post' }
  & Pick<Post, 'id' | 'createdAt' | 'updatedAt' | 'title' | 'subtitle' | 'poster' | 'points' | 'textSnippet' | 'voteStatus'>
  & {
    creator: (
      { __typename?: 'User' }
...
export type CreatePostMutation = (
  ...
  & {
    createPost: (
      { __typename?: 'Post' }
      & Pick<Post, 'id' | 'createdAt' | 'updatedAt' | 'title' | 'subtitle' | 'poster' | 'text' | 'points' | 'creatorId'>
    )
  }
);
...
export type UpdatePostMutation = (
  ...
  & {
    updatePost?: Maybe<(
      { __typename?: 'Post' }
      & Pick<Post, 'id' | 'title' | 'subtitle' | 'poster' | 'text' | 'textSnippet'>
    )>
  }
);
...
export type PostQuery = (
  ...
  & {
    post?: Maybe<(
      { __typename?: 'Post' }
      & Pick<Post, 'id' | 'createdAt' | 'updatedAt' | 'title' | 'subtitle' | 'poster' | 'points' | 'text' | 'voteStatus'>
      & {
        creator: (
          { __typename?: 'User' }
          & Pick<User, 'id' | 'username'>
...
export const UpdatePostDocument = gql`
    mutation UpdatePost($id: Int!, $title: String!, $text: String!,$subtitle: String!, $poster: String!) {
  updatePost(id: $id, title: $title, text: $text, subtitle: $subtitle, poster:$poster) {
    id
    title
    subtitle
    poster
